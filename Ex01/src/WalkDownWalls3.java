...
class RobotThatCanWalkDownWalls33 extends Robot
{
    RobotThatCanWalkDownWalls33(City c, int st, int ave, Direction dir, int num)
    {
...
public class WalkDownWalls3 extends Object
{
    public static void main(String[] args)
    {
        City wallingford = new City();
        RobotThatCanWalkDownWalls33 jo = new RobotThatCanWalkDownWalls33(wallingford, 0, 1, Direction.EAST, 0);
