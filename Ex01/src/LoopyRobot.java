...
public class LoopyRobot extends Robot
{
    ...
    static final int NUM_THINGS_INITIALLY_IN_BACKPACK = 25;
    ...
    public int putRandomNumThings()
    {
        ...
        while (counter < numThingsToPut)
        {
            ...
            // if (counter >= (NUM_THINGS_TO_PUT_ON_STREET1 + 1))
    ...
    public void putThings(int numThingsToPut)
    {
        ...
        for (int i = 0; i < numThingsToPut; i++)
        {
            this.putThing();
            this.move();
            System.out.println(" Number of things put " + i);
...
//		
    ...
    public void printScrollStatus()
    {
        ...
        int currentStreet = getStreet(); //add for Streets
        if (currentAve > -1 || currentAve < 7)
        {
            System.out.println("You do not need to scroll to see the LoopyRobot");
        } else if (currentStreet > -1 || currentStreet < 7) //adding code for streets 
        {
            System.out.println("You do not need to scroll to see the LoopyRobot");
        } else
        {
