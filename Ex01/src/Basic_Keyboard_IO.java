...
public class Basic_Keyboard_IO extends Object
{
    public static void main(String[] args)
    {
        ...
        System.out.println("inital numMoves set to :" + numMoves); //added to track
        System.out.println("inital counter set to :" + counter); //added to track
        ...
        while (counter < numMoves)
        {
            mary.move();
            System.out.println("mary.getAvenue():" + mary.getAvenue());
            System.out.println("In loop counter has been updated to:" + ++counter);
