...
public class Exercise_13_Harvester extends Robot
{
    ...
    /**
     * Moves forward only if the front is clear
     */
    public void move()
    {
    ...
    /**
     * Picks things if things are available and will loop to pick as long as more things are available
     * uses canPickThing method
     */
    public void pickThing()
    {

        System.out.println("Picking from (" + this.getStreet() + ", " + this.getAvenue() + ")");
        while (this.canPickThing())
        {
            super.pickThing();

        }
        System.out.println(" Things in Bagpack now  " + this.countThingsInBackpack());

    }

    /**
     * Puts things as long as there are things in the bag pack uses countThingsIBackpack() method
     */
    public void putThing()
    {

        System.out.println(" Will try to Putting from Bagpack things " + this.countThingsInBackpack());

        while (this.countThingsInBackpack() >= 1)
        {
            System.out.println(" called Put thing for things " + this.countThingsInBackpack());
            super.putThing();
